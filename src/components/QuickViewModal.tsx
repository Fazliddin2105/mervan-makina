      ...
      <div className="relative flex max-h-[calc(100vh-2rem)] w-full max-w-4xl flex-col overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg animate-in fade-in zoom-in-95 duration-200">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            {/* Gallery Left */}
            <div className="relative flex flex-col justify-between border-b border-slate-100 bg-gradient-to-b from-slate-50 to-slate-100/70 p-6 md:border-b-0 md:border-r">
              <div className="flex h-56 w-full items-center justify-center p-4 sm:h-64">
            ...
            <div className="flex flex-col justify-between p-6 sm:p-6">
              <div>
                ...
                <h2 className="mt-2 text-xl sm:text-2xl font-bold text-[#0B1D3F] pr-12">
                  {product.name}
                </h2>
